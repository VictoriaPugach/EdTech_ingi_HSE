...
export function SessionPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      {/* В общей комнате «Защита» анонимный режим — это норма (все входят в один
          класс), поэтому информационный баннер там не показываем, чтобы не смущать. */}
      {anonymous && sessionId !== 'defense' && (
